...
- name: Turf
  desc: 地理空间分析库，处理各种地图算法
  avatar: https://turfjs.fenxianglu.cn/assets/favicon.ico
...
- name: Avue
  desc: 基于Element二次封装的低代码前端框架
  avatar: https://avuejs.com/images/logo.png
